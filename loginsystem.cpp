...
void LoginSystem::on_bookButton_clicked()
{
    ui->winStack->setCurrentIndex(5);
}

void LoginSystem::on_addbo_clicked()
{
    QSqlQuery iQuery(db.db); 
...
void LoginSystem::on_uplButton_3_clicked()
{
...
void LoginSystem::on_back_clicked() {
    ui->bookname->setText("");
...
void LoginSystem::on_searchbook_clicked() {
    ui->winStack->setCurrentIndex(7);
}


void LoginSystem::on_back_2_clicked() {
    ui->bookname->setText("");
    ui->bookwriter->setText("");
    ui->Year_pub->setText("");
    ui->category->setText("");
...
void LoginSystem::on_back_3_clicked()
{
    ui->book_2->setText("");
    ui->writer_2->setText("");
    ui->y_o_p_2->setText("");
...
void LoginSystem::on_listbook_clicked()
{
   qDebug() << "exact";
...
void LoginSystem::on_search_clicked()
{
    this->bookname = ui->bookname_2->text();
    QSqlQuery fetcher;
    fetcher.prepare("SELECT * FROM book WHERE book_name = (:bn)");
